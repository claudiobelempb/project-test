...
public class ProductCreateDTO implements Serializable {
  ...
  public ProductCreateDTO(Long id, String name, String description, Double price, String imgUrl, TypeStatus status,
  ...
  public ProductCreateDTO(Product product, Set<Category> categories) {
    this(product);
